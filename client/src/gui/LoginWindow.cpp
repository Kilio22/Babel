...
, topText(this)
{
    ...
    this->setWindowTitle("Babybel - Login");
...
void Babel::Client::Gui::LoginWindow::submitLogin() {
    std::cout << "Username : " << username.text().toStdString() << std::endl;
    std::cout << "Password : " << password.text().toStdString() << std::endl;
    try {
        evaluateForms();
        // TODO
        ...
        // TODO
        // POUR ANTOINE (ou moi plus tard jsp).
        // Tu throw ça quand le username / mdp est pas bon.
        (void)e;
        ...
        (void)e;
        topText.setText("La connection au serveur à échoué.");
        return;
    }
    username.text().clear();
    password.text().clear();
